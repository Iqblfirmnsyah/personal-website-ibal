...
var typed = new Typed(".typing", {
  strings: ["a Student", "a Junior Web Developer","a UI/UX Designer", "a Graphic Designer"],
  typeSpeed: 100,
  BackSpeed: 60,
  loop: true,
});
...
function downloadCV() {
  ...
  link.href = 'assets/CV_IqbalFirmansyah.pdf';
  link.download = 'CV-IqbalFirmansyah.pdf';
